...
class _TarefasPageState extends State<TarefaPage>{
  ...
  static const String baseUrl = "http://10.109.197.27:3008/tarefas";
  ...
  void _carregarTarefas() async{
    try {
      ...
      print("Erro ao buscar Tarfeas: $e");
      
    }
  }

  //método para add tarefas
  ...
  //continuar na proxima aula - cenas dos proximos capítulos
  //remover tarefas
  //modificar tarefas
